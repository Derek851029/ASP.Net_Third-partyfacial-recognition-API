...
<asp:Content ID="Content" ContentPlaceHolderID="head2" runat="Server">
    ...
    <script type="text/javascript">
                ...
                success: function (doc) {
                    var table = $('#data').DataTable({
                        ...
                        columns: [
                            ...
                            {
                                data: "ROLE_ID", render: function (data, type, row, meta) {
                                    return "<input type='button' id='btn_delete" + data + "' class='btn btn-danger btn-lg' value='刪除權限' onclick='DeleteRoleID(" + data + ")'/>";
                                }
                            }
                        ]
                    });
        ...
        function DeleteRoleID(roleID) {
            $.ajax({
                type:'POST',
                url: '0060010001.aspx/deleteRoleID',
                contentType: 'application/json;charset=utf-8',
                data: JSON.stringify({
                    RoleID : roleID
                }),
        ...
        <table id="data" class="display table table-striped" style="width: 99%">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;">刪除權限</th>
                </tr>
            </thead>
        </table>
    </div>
