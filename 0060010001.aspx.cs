...
public partial class _0060010001 : System.Web.UI.Page
{
    ...
    public static void Check()
    {
        ...
        if (Check == "NO")
        {
            System.Web.HttpContext.Current.Response.Redirect("~/ExHandle.aspx");
        }
    }
    ...
    [WebMethod(EnableSession = true)]//或[WebMethod(true)]
    public static string deleteRoleID(string RoleID)
    {
        var a = DBTool.Query<CMS_0060010000>(string.Format(@"DELETE ROLELIST WHERE ROLE_ID = N'{0}' SELECT '刪除成功' AS SUCCESS", RoleID), new {});
        string outputJson = JsonConvert.SerializeObject(a);
        return outputJson;
    }
